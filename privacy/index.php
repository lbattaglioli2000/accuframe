...
?>
  ...
  <head>
    <title>AccuFrame.com Privacy Policy</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <p>We collect information from you when you subscribe to a newsletter, respond to a survey, fill out a form, Use Live Chat or enter information on our site.</p>
          ...
          <ul>
              ...
              <li>By calling us</li>
              <li>By chatting with us or by sending us a support ticket</li></li>
          </ul>
          ...
          <ul>
              <li>Email: <a href="mailto:unsubscribe@accuframe.com">unsubscribe@accuframe.com</a></li>
              <li>Clicking the unsubscribe button at the bottom of all our emails.</li>
          </ul>
          <h3>Contact us</h3>
