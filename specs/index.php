...
?>
  ...
  <head>
    <title>Specifications and Testimonials</title>
      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered">
              <thead class="thead-default">
                <tr>
                  <th>Test Pressure (Pa)</th>
                  <th>Gasketed Infiltration Leakage Rate (cfm/ft)</th>
                  <th>Regular Infiltration Leakage Rate (cfm/ft)</th>
                  <th>Percent Leakage Reduction from Gasket (cfm/ft)</th>
                  <th>Gasketed Exfiltration Leakage Rate (cfm/ft)</th>
                  <th>Regular Exfiltration Leakage Rate (cfm/ft)</th>
                  <th>Percent Leakage Reduction from Gasket</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                ...
                <tr>
                  <td>75</td><td>0.027</td><td>0.133</td><td>80%</td><td>0.017</td><td>0.057</td><td>71%</td>
                </tr>
                <tr>
                  <td>100</td><td>0.033</td><td>0.177</td><td>81%</td><td>0.027</td><td>0.070</td><td>62%</td>
                </tr>
                <tr>
                  <td>150</td><td>0.057</td><td>0.247</td><td>77%</td><td>0.043</td><td>0.083</td><td>48%</td>
                </tr>
                <tr>
                  <td>250</td><td>0.100</td><td>0.400</td><td>75%</td><td>0.067</td><td>0.117</td><td>43%</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <p id="hfh"></p>
            ...
            <blockquote class="blockquote well">
                <p>"I like the fact that it not only meets todays threshold; it exceeds the new codes for 2018."</p>
                <footer>
                  Peter Collisson<br>
        ...
        <div class="col-md-4">
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">Tips and Suggestions</div>
            <div class="panel-body">
              <p><b>We've compiled a couple of tips and suggestions for you to consider...</b></p>
              <ul>
                <li>AccuFrame needs to be continuous on all exterior walls to ensure optimal performance.</li>
                <li>Accidental tears, rips and seams can be repaired with clear silicone.</li>
              </ul>
            </div>
          </div>
          <div class="panel panel-primary">
